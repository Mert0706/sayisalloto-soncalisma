...
public class SayisalLoto_V1 {
    public static void main(String[] args) {
        ...
        //Java8 ile birlikte çoklu değişken initialize etme özelliği geldi
        ...
        //sayı2 sayi1'e eşit olduğu sürece, sayı2'yi yeniden üret diyoruz.
        //sayi2 sayi1'e eşit olmadığı zmana döngüden çıkabilir.
        while(sayi1 == sayi2){
            sayi2 = rnd.nextInt(49) +1;
        }
